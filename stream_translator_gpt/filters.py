...
def japanese_stream_filter(text: str):
    for filter_pattern in [
            ...
            r'また次回の動画でお会いしましょう', r'ご覧いただきありがとうございます', r'最後までご視聴頂き有難うございました', r'最後までご視聴頂き有難う御座いました', r'チャンネル登録よろしくお願いします', r'おつかれさまです', r'チャンネル登録よろしくね'
    ]:
    ...
    for filter_text in ['エンディング', '次回予告', 'またね', 'ありがとうございました', 'それではまた', 'それではまた。', 'また会いましょう']:
        if filter_text == text:
            print('filter', text)
            return ''
